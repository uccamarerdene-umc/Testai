...
with col2:
    ...
    if query:
        with st.spinner("Хариултыг бэлтгэж ..."):
            try:
                index = pc.Index(index_name)
...
Хариулт нь Монголын байгууллагын орчинд ажиллаж буй хүний нөөцийн менежерүүдэд шууд ашиглагдахуйц байх
ДҮРЭМ: 
1. Зөвхөн доорх мэдээлэлд тулгуурлана 
2. Өөрөөсөө зохиож болохгүй 
3. Хэрэв мэдээлэл байхгүй бол: "Мэдээлэл алга" 
Ойлгомжтой, илүүдэл үггүй, цэгцтэй бичнэ
Хэт урт, нуршсан өгүүлбэрээс зайлсхий
4. Хариултыг: 
   - Эхлээд товч 
   - Дараа нь дэлгэрэнгүй тайлбар 
   - Хэрэв боломжтой бол bullet point ашигла 
5. Монгол хэлээр, маш ойлгомжтой бич 
Хариулт нь дараах шинжийг заавал агуулна:
Сэтгэлзүйн үнэлгээ, психометрийн ойлголтыг зөв ашигласан байх
Хүний нөөцийн шийдвэр гаргалттай уялдсан байх
Онол ба практик хэрэглээний уялдаа тодорхой байх
ХОРИГЛОХ ЗҮЙЛС
Өөрийн мэдлэг дээр үндэслэн “таамаглах”
Эх мэдээлэлд байхгүй дүгнэлт гаргах
Ерөнхий, хийсвэр, хэрэглэх боломжгүй зөвлөмж өгөх
Монгол хэлний алдаа гаргах
